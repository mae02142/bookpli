...
//
//import com.project.bookpli.auth.dto.SpotifyUserDTO;
...
//
//        // 2. 회원 정보 조회
//        UserDTO spotifyUser = fetchSpotifyUserProfile(accessToken);
//
//        // 3. DB 저장
//        Optional<User> existingUser = userRepository.findBySpotifyUserId(UserDTO.getId());
//
